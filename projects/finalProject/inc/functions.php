    ...
    function displayResults() {
        ...
        if(isset($items)) {
            ...
            foreach ($items as $item) {
                ...
                echo "<tr>";
                echo "<td><img src='$itemImage' class = 'images'></td>";
                echo "<td><h4><a href='#'class='bookLink' id=$itemId>$itemName</a></h4></td>";
    ...
    function displayCart() {
        ...
        if(isset($_SESSION['cart'])) {
            ...
            foreach($_SESSION['cart'] as $item) {
                ...
                echo "<tr>";
                echo "<td><img src='" .$item['image']. "' class = 'images'></td>";
                echo "<td><h4><a href='#' class='bookLink' id=$itemId>".$item['name']."</a></h4></td>";
